...
public class P1CheckBox extends CheckBox {

    public P1CheckBox(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs, defStyle);
    }

    public P1CheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public P1CheckBox(Context context) {
        super(context);
        init(context, null, 0);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            setPadding(0, this.getPaddingTop(), getPaddingRight(), getPaddingBottom());
        }
    }
}
